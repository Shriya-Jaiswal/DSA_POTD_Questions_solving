...
// // ▶️ Ask by :  Google, Meta, Microsoft, GoldmanSachs, Paytm, Walmart

// // ▶️ Approach-1 (Recursion+Memo)
// // ⏲️ Time Complexity : O(n * log k), where k is the number range to find the nth ugly number.
// // 🛢️ Space Complexity : O(u), where U is the number of distinct values stored in the memoization map mp.
